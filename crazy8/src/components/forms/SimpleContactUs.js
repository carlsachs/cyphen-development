...
const FormContainer = styled.div`
  ...
  input,textarea {
    ${tw`w-full bg-transparent text-gray-100 text-base font-medium tracking-wide border-b-2 py-2 text-blue-200 hocus:border-pink-400 focus:outline-none transition duration-200`};
