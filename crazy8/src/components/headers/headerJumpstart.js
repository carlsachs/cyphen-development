...
export const NavLink = tw.a`
  ...
  pb-1 border-b-2 border-transparent text-purple-500 hover:border-purple-400 hocus:text-purple-700
`;
...
export const MobileNavLinks = motion.custom(styled.div`
  ${tw`lg:hidden z-10 fixed top-0 inset-x-0 mx-4 my-6 p-8 border text-center rounded-lg text-purple-500 bg-white`}
  ${NavLinks} {
